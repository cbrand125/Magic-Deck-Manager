...
class PieChartView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        func createGradientImageUsingRect(rect: CGRect) -> UIImage {
            ...
            let gradient = CGGradientCreateWithColorComponents(rgbColorspace, components, locations, Int(locationsCount));
            ...
            CGContextDrawLinearGradient(ctx3, gradient, topCenterPoint, bottomCenterPoint, CGGradientDrawingOptions.DrawsBeforeStartLocation);
        ...
        let maskImg: UIImage = createCircleMaskUsingCenterPoint(center, radius: Float(r))
        let gradientImage = createGradientImageUsingRect(self.bounds)
        _ = maskImage(gradientImage, maskImage: maskImg)
